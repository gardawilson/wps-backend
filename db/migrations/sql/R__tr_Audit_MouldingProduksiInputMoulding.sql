/* ===== [dbo].[tr_Audit_MouldingProduksiInputMoulding] ON [dbo].[MouldingProduksiInputMoulding] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_MouldingProduksiInputMoulding]
ON [dbo].[MouldingProduksiInputMoulding]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_MouldingProduksiInputMoulding] ', ERROR_MESSAGE());
  END CATCH
END;
GO
