/* ===== [dbo].[tr_Audit_MouldingProduksi_h] ON [dbo].[MouldingProduksi_h] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_MouldingProduksi_h]
ON [dbo].[MouldingProduksi_h]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_MouldingProduksi_h] ', ERROR_MESSAGE());
  END CATCH
END;
GO
