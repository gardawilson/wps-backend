/* ===== [dbo].[tr_Audit_PackingProduksiInputCCAkhir] ON [dbo].[PackingProduksiInputCCAkhir] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_PackingProduksiInputCCAkhir]
ON [dbo].[PackingProduksiInputCCAkhir]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_PackingProduksiInputCCAkhir] ', ERROR_MESSAGE());
  END CATCH
END;
GO