/* ===== [dbo].[tr_Audit_LaminatingProduksiInputMoulding] ON [dbo].[LaminatingProduksiInputMoulding] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_LaminatingProduksiInputMoulding]
ON [dbo].[LaminatingProduksiInputMoulding]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_LaminatingProduksiInputMoulding] ', ERROR_MESSAGE());
  END CATCH
END;
GO
