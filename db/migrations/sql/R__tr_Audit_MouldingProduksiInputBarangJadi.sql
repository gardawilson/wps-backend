/* ===== [dbo].[tr_Audit_MouldingProduksiInputBarangJadi] ON [dbo].[MouldingProduksiInputBarangJadi] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_MouldingProduksiInputBarangJadi]
ON [dbo].[MouldingProduksiInputBarangJadi]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_MouldingProduksiInputBarangJadi] ', ERROR_MESSAGE());
  END CATCH
END;
GO
