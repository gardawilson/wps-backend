/* ===== [dbo].[tr_Audit_MouldingProduksiInputSanding] ON [dbo].[MouldingProduksiInputSanding] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_MouldingProduksiInputSanding]
ON [dbo].[MouldingProduksiInputSanding]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_MouldingProduksiInputSanding] ', ERROR_MESSAGE());
  END CATCH
END;
GO
