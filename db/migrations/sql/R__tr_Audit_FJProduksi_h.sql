/* ===== [dbo].[tr_Audit_FJProduksi_h] ON [dbo].[FJProduksi_h] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_FJProduksi_h]
ON [dbo].[FJProduksi_h]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_FJProduksi_h] ', ERROR_MESSAGE());
  END CATCH
END;
GO
