/* ===== [dbo].[tr_Audit_S4SProduksiInputS4S] ON [dbo].[S4SProduksiInputS4S] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_S4SProduksiInputS4S]
ON [dbo].[S4SProduksiInputS4S]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_S4SProduksiInputS4S] ', ERROR_MESSAGE());
  END CATCH
END;
GO
