/* ===== [dbo].[tr_Audit_MouldingProduksiInputS4S] ON [dbo].[MouldingProduksiInputS4S] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_MouldingProduksiInputS4S]
ON [dbo].[MouldingProduksiInputS4S]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_MouldingProduksiInputS4S] ', ERROR_MESSAGE());
  END CATCH
END;
GO
