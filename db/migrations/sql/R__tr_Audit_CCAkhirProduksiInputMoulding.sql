/* ===== [dbo].[tr_Audit_CCAkhirProduksiInputMoulding] ON [dbo].[CCAkhirProduksiInputMoulding] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_CCAkhirProduksiInputMoulding]
ON [dbo].[CCAkhirProduksiInputMoulding]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_CCAkhirProduksiInputMoulding] ', ERROR_MESSAGE());
  END CATCH
END;
GO
