/* ===== [dbo].[tr_Audit_MouldingProduksiInputFJ] ON [dbo].[MouldingProduksiInputFJ] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_MouldingProduksiInputFJ]
ON [dbo].[MouldingProduksiInputFJ]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_MouldingProduksiInputFJ] ', ERROR_MESSAGE());
  END CATCH
END;
GO
