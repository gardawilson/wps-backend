/* ===== [dbo].[tr_Audit_PackingProduksiInputBarangJadi] ON [dbo].[PackingProduksiInputBarangJadi] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_PackingProduksiInputBarangJadi]
ON [dbo].[PackingProduksiInputBarangJadi]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_PackingProduksiInputBarangJadi] ', ERROR_MESSAGE());
  END CATCH
END;
GO