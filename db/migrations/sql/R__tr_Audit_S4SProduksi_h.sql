/* ===== [dbo].[tr_Audit_S4SProduksi_h] ON [dbo].[S4SProduksi_h] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_S4SProduksi_h]
ON [dbo].[S4SProduksi_h]
...
BEGIN
  ...
  BEGIN CATCH
    ...
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_S4SProduksi_h] ', ERROR_MESSAGE());
  END CATCH
END;
GO
