/* ===== [dbo].[tr_Audit_CCAkhirProduksiInputCCAkhir] ON [dbo].[CCAkhirProduksiInputCCAkhir] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_CCAkhirProduksiInputCCAkhir]
ON [dbo].[CCAkhirProduksiInputCCAkhir]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_CCAkhirProduksiInputCCAkhir] ', ERROR_MESSAGE());
  END CATCH
END;
GO
