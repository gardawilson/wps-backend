/* ===== [dbo].[tr_Audit_PackingProduksiInputSanding] ON [dbo].[PackingProduksiInputSanding] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_PackingProduksiInputSanding]
ON [dbo].[PackingProduksiInputSanding]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_PackingProduksiInputSanding] ', ERROR_MESSAGE());
  END CATCH
END;
GO