/* ===== [dbo].[tr_Audit_SandingProduksiInputSanding] ON [dbo].[SandingProduksiInputSanding] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_SandingProduksiInputSanding]
ON [dbo].[SandingProduksiInputSanding]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_SandingProduksiInputSanding] ', ERROR_MESSAGE());
  END CATCH
END;
GO
