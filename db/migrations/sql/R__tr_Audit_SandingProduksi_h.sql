/* ===== [dbo].[tr_Audit_SandingProduksi_h] ON [dbo].[SandingProduksi_h] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_SandingProduksi_h]
ON [dbo].[SandingProduksi_h]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_SandingProduksi_h] ', ERROR_MESSAGE());
  END CATCH
END;
GO
