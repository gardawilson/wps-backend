/* ===== [dbo].[tr_Audit_SandingProduksiInputBarangJadi] ON [dbo].[SandingProduksiInputBarangJadi] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_SandingProduksiInputBarangJadi]
ON [dbo].[SandingProduksiInputBarangJadi]
...
BEGIN
  ...
  BEGIN TRY
    ...
    BEGIN
      ...
      SELECT
        'CONSUME',
        'SandingProduksiInputBarangJadi',
        @actor,
        @rid,
        @pk,
        NULL,
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_SandingProduksiInputBarangJadi] ', ERROR_MESSAGE());
  END CATCH
END;
GO
