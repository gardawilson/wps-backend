/* ===== [dbo].[tr_Audit_FJ_d] ON [dbo].[FJ_d] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_FJ_d]
ON [dbo].[FJ_d]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_FJ_d] ', ERROR_MESSAGE());
  END CATCH
END;
GO
