/* ===== [dbo].[tr_Audit_SandingProduksiInputCCAkhir] ON [dbo].[SandingProduksiInputCCAkhir] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_SandingProduksiInputCCAkhir]
ON [dbo].[SandingProduksiInputCCAkhir]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_SandingProduksiInputCCAkhir] ', ERROR_MESSAGE());
  END CATCH
END;
GO
