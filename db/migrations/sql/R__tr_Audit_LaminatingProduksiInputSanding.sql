/* ===== [dbo].[tr_Audit_LaminatingProduksiInputSanding] ON [dbo].[LaminatingProduksiInputSanding] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_LaminatingProduksiInputSanding]
ON [dbo].[LaminatingProduksiInputSanding]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_LaminatingProduksiInputSanding] ', ERROR_MESSAGE());
  END CATCH
END;
GO
