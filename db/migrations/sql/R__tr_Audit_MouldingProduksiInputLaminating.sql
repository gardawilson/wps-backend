/* ===== [dbo].[tr_Audit_MouldingProduksiInputLaminating] ON [dbo].[MouldingProduksiInputLaminating] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_MouldingProduksiInputLaminating]
ON [dbo].[MouldingProduksiInputLaminating]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_MouldingProduksiInputLaminating] ', ERROR_MESSAGE());
  END CATCH
END;
GO
