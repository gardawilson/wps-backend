/* ===== [dbo].[tr_Audit_CCAkhirProduksi_h] ON [dbo].[CCAkhirProduksi_h] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_CCAkhirProduksi_h]
ON [dbo].[CCAkhirProduksi_h]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_CCAkhirProduksi_h] ', ERROR_MESSAGE());
  END CATCH
END;
GO
