/* ===== [dbo].[tr_Audit_LaminatingProduksiInputBarangJadi] ON [dbo].[LaminatingProduksiInputBarangJadi] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_LaminatingProduksiInputBarangJadi]
ON [dbo].[LaminatingProduksiInputBarangJadi]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_LaminatingProduksiInputBarangJadi] ', ERROR_MESSAGE());
  END CATCH
END;
GO
