/* ===== [dbo].[tr_Audit_PackingProduksiInputMoulding] ON [dbo].[PackingProduksiInputMoulding] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_PackingProduksiInputMoulding]
ON [dbo].[PackingProduksiInputMoulding]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_PackingProduksiInputMoulding] ', ERROR_MESSAGE());
  END CATCH
END;
GO