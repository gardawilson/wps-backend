/* ===== [dbo].[tr_Audit_S4SProduksiInputCCAkhir] ON [dbo].[S4SProduksiInputCCAkhir] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_S4SProduksiInputCCAkhir]
ON [dbo].[S4SProduksiInputCCAkhir]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_S4SProduksiInputCCAkhir] ', ERROR_MESSAGE());
  END CATCH
END;
GO
