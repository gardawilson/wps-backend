/* ===== [dbo].[tr_Audit_FJProduksiInputCCAkhir] ON [dbo].[FJProduksiInputCCAkhir] ===== */
CREATE OR ALTER TRIGGER [dbo].[tr_Audit_FJProduksiInputCCAkhir]
ON [dbo].[FJProduksiInputCCAkhir]
...
BEGIN
  ...
  END TRY
  BEGIN CATCH
    PRINT CONCAT('[AUDIT_WARN][tr_Audit_FJProduksiInputCCAkhir] ', ERROR_MESSAGE());
  END CATCH
END;
GO
